...
// Check if user has made a reservation
$userHasReservation = false;
if (isset($_SESSION['user_id'])) {
    $userId = $_SESSION['user_id'];
    $reservationQuery = "SELECT * FROM reservations WHERE user_id = $userId AND status = 'Accepted'";
...
<main id="rooms">
    ...
    <section class="reviews-container" id="reviews">
        ...
        <?php } elseif (isset($_SESSION['user_id'])) { ?>
            <p class="login-prompt">You need to make a reservation to leave a review.</p>
        <?php } else { ?>
